                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
                                            ...
                                            <tr>
													<td><strong>Semester & Branch:</strong></td>
											...
											<tr>
													...
													<?php 
																		   ...
																		   <?php 
																			 ...
																			 { ?>
																			<td>   <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>Getting Ready</button></center></td> 
																			<?php
																				}
																			if($status=="closed")
																				{
