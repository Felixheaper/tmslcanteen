        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/techno.jpg" alt="" width="45" height="45"> </a>
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Collect from respective canteen choosen</td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                ...
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                  <img src="images\tmsl.png" alt="VVCE" width="150" height="150" align="right">
                                </div>
                    </div>
                </div>
