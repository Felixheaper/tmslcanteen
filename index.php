...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icn.png" alt=""width="60" height="60" > </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/111.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>    TMSL CANTEEN AUTOMATION SYSTEM </h1>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose any canteen featured below</h3>
                                    <p>We have got you covered with menus from a variety of canteens available in our institution.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose your fav dish</h3>
                                <p>Use the cart to cover up all your orders at one go.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Go and Enjoy your Meal</h3>
                                <p>Eliminating Long Queues!!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Techno Main Salt Lake
</p>
                                    <h5>Phone: 9876543210</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                  <img src="images\tmsl.png" alt="VVCE" width="200" height="100" align="right">
                                </div>
                    </div>
                </div>
